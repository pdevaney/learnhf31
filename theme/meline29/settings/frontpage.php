 ...
 */
    ...
    $name = 'theme_meline29/showhidewelcomeblock';
    ...
    $name = 'theme_meline29/welcometitle';
    ...
    // Caption.
    $name = 'theme_meline29/welcomecontent';
    ...
    /**  Display Manin content Block One **/
    
    $name = 'theme_meline29/showhideblockone';
    ...
    $name = 'theme_meline29/blockoneimage';
    $title = get_string('blockoneimage', 'theme_meline29');
    $description = get_string('blockoneimagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blockoneimage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imageonehovertitle';
    ...
    $name = 'theme_meline29/imageonehovercontent';
    ...
    $name = 'theme_meline29/showhideblocktwo';
    ...
    $name = 'theme_meline29/blocktwoimage';
    $title = get_string('blocktwoimage', 'theme_meline29');
    $description = get_string('blocktwoimagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blocktwoimage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imagetwohovertitle';
    ...
    $name = 'theme_meline29/imagetwohovercontent';
    ...
    /**  Display Manin content Block Three **/

    $name = 'theme_meline29/showhideblockthree';
    ...
    $name = 'theme_meline29/blockthreeimage';
    $title = get_string('blockthreeimage', 'theme_meline29');
    $description = get_string('blockthreeimagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blockthreeimage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imagethreehovertitle';
    ...
    $name = 'theme_meline29/imagethreehovercontent';
    ...
    $name = 'theme_meline29/showhideblockfour';
    ...
    $name = 'theme_meline29/blockfourimage';
    $title = get_string('blockfourimage', 'theme_meline29');
    $description = get_string('blockfourimagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blockfourimage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imagefourhovertitle';
    ...
    $name = 'theme_meline29/imagefourhovercontent';
    ...
    $name = 'theme_meline29/showhideblockfive';
    ...
    $name = 'theme_meline29/blockfiveimage';
    $title = get_string('blockfiveimage', 'theme_meline29');
    $description = get_string('blockfiveimagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blockfiveimage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imagefivehovertitle';
    ...
    $name = 'theme_meline29/imagefivehovercontent';
    ...
    $name = 'theme_meline29/showhideblocksix';
    ...
    $name = 'theme_meline29/blocksiximage';
    $title = get_string('blocksiximage', 'theme_meline29');
    $description = get_string('blocksiximagedesc', 'theme_meline29');
    $setting = new admin_setting_configstoredfile($name, $title, $description, 'blocksiximage');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
    ...
    $name = 'theme_meline29/imagesixhovertitle';
    ...
    $name = 'theme_meline29/imagesixhovercontent';
    ...
    $name = 'theme_meline29/testimonialblocktitle';
	...
	$name = 'theme_meline29/testimonialblockcontent';
