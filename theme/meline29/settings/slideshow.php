...
// Toggle Slideshow.
$name = 'theme_meline29/toggleslideshow';
...
// Slideshow height:
$name = 'theme_meline29/slideshowheight';
...
// Image sizing:
$name = 'theme_meline29/slideshowsizingmode';
...
// Number of slides.
$name = 'theme_meline29/slideshownumber';
...
$name = 'theme_meline29/slideshowtitlecolor';
...
$name = 'theme_meline29/slideshowcaptioncolor';
...
$name = 'theme_meline29/slideshowbuttontype';
...
$name = 'theme_meline29/slideshowautoplay';
...
// Slideshow animation
$name = 'theme_meline29/slideshowanimation';
...
// Slideshow caption color
$name = 'theme_meline29/slideshowarrowscolor';
...
$name = 'theme_meline29/slideshowkenburns';
...
$addSlideSettings = function($i, &$temp) {
    ...
    $name = "theme_meline29/slide{$i}info";
    $params = new stdClass();
    $params->n = $i;
    ...
    // Image.
    $name = "theme_meline29/slide{$i}image";
    ...
    // Caption.
    $name = "theme_meline29/slide{$i}caption";
    ...
    // URL.
    $name = "theme_meline29/slide{$i}url";
    ...
    // URL text
    $name = "theme_meline29/slide{$i}urltext";
    ...
    // Caption placement
    $name = "theme_meline29/slide{$i}captionplacement";
