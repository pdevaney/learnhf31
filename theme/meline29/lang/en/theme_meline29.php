...
$string['welcome'] = 'Frontpage Welcome Block Settings.';

$string['showhidewelcomeblock'] = 'Display Welcome Block';
$string['showhidewelcomeblockdesc'] = 'Show OR hide your banner';

$string['welcometitle'] = 'Welcome Block Title';
$string['welcometitledesc'] = 'Enter the text for first button';

$string['welcomecontent'] = 'Welcome Block: Content'; 
...
$string['testimonials'] = 'Testimonials Block Settings.';

$string['showhidetestimonialsblock'] = 'Display Testimonials Block'; 
$string['showhidetestimonialsblockdesc'] = 'Display testimonials';

$string['testimonialblocktitle'] = 'Testimonial Block Top Title';
$string['testimonialblocktitledesc'] = 'Enter testimonials block top title';

$string['testimonialblockcontent'] = 'Testimonial Block Top Content';
$string['testimonialblockcontentdesc'] = 'Enter testimonials block top content';
...
$string['testimonialoneuserpic'] = 'Testimonial One User Picture';
$string['testimonialoneuserpicdesc'] = 'Drag and drop testimonial one user picture';
